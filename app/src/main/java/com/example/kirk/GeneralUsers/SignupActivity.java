...
public class SignupActivity extends AppCompatActivity {
    ...
    private final String PUBLIC_KEY = "FLWPUBK_TEST-7efd6711e31b6abe0a9d8cdddf9f761d-X", ENCRYPTION_KEY = "FLWSECK_TEST2415da1f44d4", SECRET_KEY = "FLWSECK_TEST-43eb4121cc5efbac4d84f25e5cfda633-X";
    ...
    private void initializeRave() {
        ...
        transaction.acceptAccountPayments(true);
        transaction.acceptCardPayments(true);
        transaction.acceptMpesaPayments(false);
        transaction.acceptBankTransferPayments(true);
        transaction.acceptUssdPayments(true);
        transaction.acceptBarterPayments(true);
        transaction.onStagingEnv(true);
